...
For odd birthdays (1, 3, 5 ... n) he receives toys, and for each even (2, 4, 6 ... n) he receives money. 
For the second birthday he receives BGN 10.00, the amount being increased by BGN 10.00, 
for each subsequent even birthday (2 -> 10, 4 -> 20, 6 -> 30 ... etc.). Over the years, Lily has secretly saved money. 
Lily's brother, in the years she received money, took BGN 1.00 from them. 

Lily sold the toys received over the years, each for P BGN and added the amount to the money saved. 
With the money she wanted to buy a washing machine for X leva. 
